<x-app-layout>
    ...
    style="background-color: black; color: white; padding: 10px; border: none; border-radius: 5px; text-decoration: none;">
    ...
    <tbody>
        @foreach($categorias as $categoria)
            <tr class="hover:bg-gray-50">
                ...
                <td> <form method="POST" action="{{ route('categorias.destroy', $categoria) }}" style="display:inline;">
    @csrf
    @method('DELETE')
